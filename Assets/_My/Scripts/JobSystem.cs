...
public class JobSystem
{
    ...
    public struct JobInfo
    {
        ...
        public float minSpeedIndex;             // 최소 속도 지수
        public float maxSpeedIndex;             // 최대 속도 지수
        ...
        {
            return $"{jobName}: 속도지수 {minSpeedIndex:F1}~{maxSpeedIndex:F1}, " +
    ...
    {
        // 대통령: 빠름~매우 빠름 (<1.0), 매우 높음 (100~120) - 최우선
        {
            JobType.President,
            new JobInfo
            {
        ...
        // 의사: 보통~느림 (1.0~1.5), 매우 높음 (100~120)
        {
            JobType.Doctor,
            new JobInfo
            {
                ...
                jobName = "의사",
                description = "당신은 긴 노력과 전문성으로 사람들의 생명을 구하는 숭고한 삶을 살고 있습니다. 꾸준하고 느린 걸음이지만 최고의 높이에 도달하여 생명을 다루는 막중한 책임을 지고 있습니다.",
                minSpeedIndex = 1.0f,
                maxSpeedIndex = 1.5f,
                minStairs = 100,
                maxStairs = 120,
        ...
        // 간호사: 보통~느림 (1.0~1.5), 높음 (81~120)
        {
            ...
            new JobInfo
            {
                ...
                jobName = "간호사",
                description = "당신은 헌신과 노력으로 타인의 아픔을 치유하는 삶을 선택했습니다. 꾸준하고 성실한 걸음으로 많은 높은 계단을 올라 안정적이고 존경받는 삶을 살고 있습니다.",
                minSpeedIndex = 1.0f,
                maxSpeedIndex = 1.5f,
                minStairs = 81,
                maxStairs = 120,
        ...
        // 교사: 보통~느림 (1.0~1.5), 중간~높음 (60~120)
        {
            ...
            new JobInfo
            {
                ...
                jobName = "교사",
                description = "당신은 인내와 가르침으로 보람 있는 삶을 살고 있습니다. 조금 느린 걸음이지만 높은 곳에 도달하여 다음 세대를 키우는 숭고한 일을 하고 있습니다.",
                minSpeedIndex = 1.0f,
                maxSpeedIndex = 1.5f,
                minStairs = 60,
                maxStairs = 120,
        ...
        // 거지: 느림~매우 느림 (>1.2), 낮음 (0~40)
        {
            ...
            new JobInfo
            {
                ...
                jobName = "거지",
                description = "당신은 목표를 잃고 방황하는 삶을 살고 있습니다. 느린 걸음과 낮은 성취로 인해 현재는 어려운 시간을 보내고 있지만, 이것이 끝이 아닙니다. 다시 일어설 기회는 언제나 존재합니다.",
                minSpeedIndex = 1.2f,
                maxSpeedIndex = float.MaxValue,
                minStairs = 0,
                maxStairs = 40,
    ...
    public static JobResult DetermineJob(float speedIndex, int stairCount)
    {
        ...
        foreach (var jobPair in jobDatabase)
        {
            ...
            // 속도 지수와 계단 수 조건 모두 만족하는지 확인
            bool speedMatch = speedIndex >= job.minSpeedIndex && speedIndex < job.maxSpeedIndex;
        ...
        else
        {
            ...
            result.isMatched = false;
            result.matchReason = "조건 불일치로 기본 직업 할당";
        }
    ...
    public static void LogAllJobConditions()
    {
        ...
        {
            string speedRange = job.maxSpeedIndex == float.MaxValue ? 
                $"{job.minSpeedIndex:F1}+" : 
                $"{job.minSpeedIndex:F1}~{job.maxSpeedIndex:F1}";
                
            Debug.Log($"{job.jobName}: 속도지수 {speedRange}, " +
